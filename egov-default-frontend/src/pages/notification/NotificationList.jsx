...
function EgovNoticeList(props) {
    ...
    const retrieveList = useCallback((searchCondition) => {
        ...
        const retrieveListURL = '/notifications';
        ...
        EgovNet.requestFetch(retrieveListURL,
            ...
            (resp) => {
                ...
                for(let i = 0; i< resp.length; i++){
                    ...
                    mutListTag.push(
                        <Link
                            to={{pathname: "/notification/NotificationDetail"}}
                            state={{
                                id: resp[i].id,
                                searchCondition: searchCondition}}                            
                            className="list_item">
                            <div>{i}</div>
                            <div>{resp[i].receiver}</div>
                            <div>{resp[i].msg}</div>
                            <div>{resp[i].date}</div>
                       </Link>
                    );
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_LIST" id="contents">
                        ...
                        <div className="top_tit">
                            <h1 className="tit_1">알림서비스</h1>
                        </div>

                        <h2 className="tit_2">Notification</h2>
                        ...
                        <div className="condition">
                            <ul>
                                ...
                                <li className="third_2 R">
                                    ...
                                    <li>
                                        <Link to="/notification/NotificationEdit" state={{bbsId: bbsId}} className="btn btn_blue_h46 pd35">등록</Link>
                                    </li>
                            </ul>
                        </div>
                        {/* <!--// 검색조건 --> */}
